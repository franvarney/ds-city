...
public class GlowPrePass : MonoBehaviour
{
	...
	void OnEnable()
	{
		...
		var glowShader = Shader.Find("Glow/Replace");
		...
		_blurMat = new Material(Shader.Find("Glow/Blur"));
		_blurMat.SetVector("_BlurSize", new Vector2(Blurred.texelSize.x * 5.5f, Blurred.texelSize.y * 5.5f));
	}
